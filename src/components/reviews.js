...
class Reviews extends Component {
  constructor( props ) {
    ...
    this.state = {
      ...
      savedReview: [{
        key: 0,
        isDisplayed: true,
        avatar: <img src="https://media-cldnry.s-nbcnews.com/image/upload/t_fit-1240w,f_auto,q_auto:best/newscms/2018_30/2512366/180727-exasperated-woman-ac-513p.jpg" height="100px" width="100px" alt=""></img>,
      ...
      },
      {
        ...
        rating: 2,
        avatar: <img src="https://muppetmindset.files.wordpress.com/2009/12/count-bats.png?w=306&h=408" height="100px" width="100px" alt=""></img>,
  ...
  handleSave() {
    ...
    if ( this.state.reviewMode === true ) {
      this.setState( {
        avatar: <img src={this.avatarContent.current.value} height="100px" width="100px" alt=""/>,
